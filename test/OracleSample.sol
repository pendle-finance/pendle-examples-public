...
contract OracleSample is PRBTest, StdCheats, StructGen {
    ...
    PendlePYLpOracle public constant oracle = PendlePYLpOracle(0x6011a86b8514A0f797bA8b3D267225337271EC55);
    ...
    IChainlinkAggregator public constant USDC_USD_Feed =
        IChainlinkAggregator(0x50834F3163758fcC1Df9973b6e91f0F0F0434aD3);

    uint32 public constant twapDuration = 900;

    function setUp() public virtual {
        vm.createSelectFork({ urlOrAlias: "arbitrum", blockNumber: 214_097_755 });
